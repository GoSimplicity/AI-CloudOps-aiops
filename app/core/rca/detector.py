...
class AnomalyDetector:
    ...
    async def detect_anomalies(
        ...
        for metric_name, df in metrics_data.items():
            try:
                ...
                anomaly_result = await self._detect_metric_anomalies(
                ...
                if anomaly_result and anomaly_result.anomaly_points:
                    anomalies[metric_name] = {
                        ...
                        "first_occurrence": anomaly_result.anomaly_points[
                            0
                        ].isoformat(),
                        "last_occurrence": anomaly_result.anomaly_points[
                            -1
                        ].isoformat(),
    ...
    def update_threshold(self, new_threshold: float):
        ...
        if 0 < new_threshold <= 1:
            ...
            logger.warning(
                f"无效的阈值: {new_threshold}, 保持当前值: {self.anomaly_threshold}"
            )
